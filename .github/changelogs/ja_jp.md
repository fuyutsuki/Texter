...
- Minecraft: Bedrock Edition 1.16.210 リリースに伴う [pmmp/PocketMine-MP](https://github.com/pmmp/PocketMine-MP) の最新リリース `3.18.0` での動作確認を行いました
...
- PocketMine-MP >= 3.15.0 が必要になりました
- PHP >= 7.4 が必要になりました
